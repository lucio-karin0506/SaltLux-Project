...
<div class="row text-center m-4" style="width: 100%">
	   ...
	   <div style="width: 70%; float:none; margin:0 auto" >
		   <form action="bicycleReturnInput.do" method="post">
		   
			검색하고 싶은 시간을 선택하세요: <p><p><select name="return_hour" style="width:600px;height:30px">
         ...
         <br>
			...
			검색하고 싶은 지역 키워드를 입력하세요:<input type="text" class="form-control m-4" name="return_office" placeholder="지역 키워드를 입력해주세요!" />
