...
<body >
	...
	<form action="/mypage/updateproblem" method="post">
	<c:forEach var="updateproblem" items="${updateproblem}" >
	<input type="hidden" name="problemId" value="${updateproblem.problemId}" readonly>
	...
	<div style="width: 70%; float: none; margin: 0 auto">
			...
			<table class="table table-bordered">
				...
				<tbody>
						...
						<tr>
								...
								<td>
										...
										<textarea name="problemContent" value="${updateproblem.problemContent}" rows="8" cols="80" >${updateproblem.problemContent}</textarea>
 										 <br><br>
				...
				<tbody>
						<tr>
								...
								<td>
										...
										<textarea name="problemCase" value="${updateproblem.problemCase}" rows="8" cols="80" >${updateproblem.problemCase}</textarea>
 										 <br><br>
				...
				<tbody><tr>
								...
								<td>
										...
										<textarea name="problemAnswer" value="${updateproblem.problemAnswer}" rows="8" cols="80">${updateproblem.problemAnswer}</textarea>
 										 <br><br>
				...
				<tr>
								...
								<td>
										...
										<textarea name="problemCommentary" value="${updateproblem.problemCommentary}" rows="8" cols="80">${updateproblem.problemCommentary}</textarea>
 										 <br><br>
		...
		<input type="submit" value="저장하기"><p><p>
		<br>
	</div>
	</c:forEach>
</form>
